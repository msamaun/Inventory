    ...
    <script>
        ...
        async function CustomerList(){
            ...
            res.data['data'].forEach(function (item,index) {
                let row=`<tr class="text-xs">
                        <td><i class="bi bi-person"></i> ${item['firstName']} ${item['lastName']}</td>
                        <td><a data-name="${item['firstName']} ${item['lastName']}" data-email="${item['email']}" data-id="${item['id']}" class="btn btn-outline-dark addCustomer  text-xxs px-2 py-1  btn-sm m-0">Add</a></td>
                     </tr>`
        ...
        async function ProductList(){
            ...
            res.data['data'].forEach(function (item,index) {
                let row=`<tr class="text-xs">
                        <td> ${item['name']} ($ ${item['unit_price']})</td>
                        <td><a data-name="${item['name']}" data-price="${item['unit_price']}" data-id="${item['id']}" class="btn btn-outline-dark text-xxs px-2 py-1 addProduct  btn-sm m-0">Add</a></td>
                     </tr>`
